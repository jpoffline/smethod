...
\subitem \codeBlue{GetDeriv\_2} -- second order accurate finite difference spatial derivatives
\subitem  \codeBlue{GetDeriv\_4} -- fourth order accurate finite difference spatial derivatives
...
\subitem \codeBlue{GetPos} -- sets values of {\tt grid.loc\_X}, and gets {\tt grid.Xp}, and  {\tt grid.Xm}
